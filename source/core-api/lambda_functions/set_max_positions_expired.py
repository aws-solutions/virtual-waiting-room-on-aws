...
def lambda_handler(event, _):
    ...
    for serving_counter_item in serving_counter_items:
        ...
        if INCR_SVC_ON_QUEUE_POS_EXPIRY == 'true':
            incr_serving_counter(serving_counter_item, serving_counter_item_position, previous_serving_counter_position)
...
def incr_serving_counter(serving_counter_item, serving_counter_item_position, previous_serving_counter_position):
    """
