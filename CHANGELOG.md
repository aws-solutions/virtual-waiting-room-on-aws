...
- bump urllib3 to `2.5.0` to mitigate security vulnerability
- bump requests to `2.32.4` to mitigate security vulnerability
- bump bootstrap to `5.1.1` to move from beta to stable release
- added npm security overrides for cross-spawn, postcss, semver, word-wrap to mitigate ReDoS and parsing vulnerabilities
