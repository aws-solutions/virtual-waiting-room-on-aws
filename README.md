**[🚀 Solution Landing Page](https://aws.amazon.com/solutions/implementations/aws-virtual-waiting-room/)** | **[🚧 Feature request](https://github.com/aws-solutions/aws-virtual-waiting-room/issues/new?assignees=&labels=feature-request%2C+enhancement&template=feature_request.md&title=)** | **[🐛 Bug Report](https://github.com/aws-solutions/aws-virtual-waiting-room/issues/new?assignees=&labels=bug%2C+triage&template=bug_report.md&title=)**
