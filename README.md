⚠️🚨⚠️ __Important: Virtual Waiting Room on AWS solution will retire in November 2025. We encourage customers to explore [Queue-it on the AWS Marketplace](https://aws.amazon.com/marketplace/seller-profile?id=e75e9234-d0c1-4847-8fb0-19e6523d2e86). You can also find other solutions in the [AWS Solutions Library](https://aws.amazon.com/solutions/new-to-aws/?awsf.solution-area-7=solutions-use-case%23uc-n2a-00080&solutions-all.sort-by=item.additionalFields.date&solutions-all.sort-order=desc&awsf.solution-type=*all&awsf.solution-area-1=*all&awsf.solution-area-2=*all&awsf.solution-area-3=*all&awsf.solution-area-4=*all&awsf.solution-area-5=*all&awsf.solution-area-6=*all&awsf.solution-area-8=*all).__ ⚠️🚨⚠️
